...
export default class SpriteLoader extends PIXI.Loader {
    ...
    init = (started) => {
        ...
        this.add("barBorder", "assets/images/world/scale_03_04.png")
            ...
            .add("potionHp", "assets/images/items/ptn_b_01.PNG")
            ...
            .add("pig", "assets/images/items/junk/pig_b_01.png")
            .add("ember", "assets/images/items/junk/ember_b_01.png")
            .add("narsil", "assets/images/items/junk/broken_sword_b_01.png")
            .add("rune", "assets/images/items/junk/runestone_b_01.png")
            .add("feather", "assets/images/items/junk/feather_b_06.png")
            .add("shards", "assets/images/items/junk/shard_b_04.png")
            .add("elementium1", "assets/images/items/junk/element(air)_b_01.png")
            .add("elementium2", "assets/images/items/junk/element(fire)_b_01.png")
            .add("elementium3", "assets/images/items/junk/element(water)_b_01.png")
            .add("elementium4", "assets/images/items/junk/elementl(earth)_b_01.png")
            ...
            .add("pants1", "assets/images/items/pants/pn_b_02.png")
            .add("pants2", "assets/images/items/pants/pn_b_03.png")
            .add("pants3", "assets/images/items/pants/pn_b_06.png")
            .add("boots1", "assets/images/items/boots/boot_b_04.png")
            .add("boots2", "assets/images/items/boots/boot_b_06.png")
            .add("boots3", "assets/images/items/boots/shadow_boots_b.png")
            .add("book1", "assets/images/items/offhand/book_03_b.png")
            .add("knife1", "assets/images/items/offhand/kn_b_03.PNG")
            .add("shield1", "assets/images/items/offhand/sh_b_08.png")
            .add("ring1", "assets/images/items/offhand/rn_b_01.PNG")
